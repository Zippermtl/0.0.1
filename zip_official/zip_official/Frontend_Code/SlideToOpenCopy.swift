...
@objc public protocol MTSlideToOpenDelegateCopy {
    func mtSlideToOpenDelegateDidFinish(_ sender: MTSlideToOpenViewCopy)
}

@objcMembers public class MTSlideToOpenViewCopy: UIView {
    ...
    public var swipeDistanceMultiplier: Double = 1
    ...
    public weak var delegate: MTSlideToOpenDelegateCopy?
