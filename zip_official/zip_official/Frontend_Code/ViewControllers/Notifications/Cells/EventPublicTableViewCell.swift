//
//  EventPublicTableViewCell.swift
//  zip_official
//
...
class EventPublicTableViewCell: UITableViewCell {
    static let identifier = "EventPublic"
    ...
    let openButton: UIButton = {
        let btn = UIButton()
        btn.layer.backgroundColor = UIColor.zipYellow.cgColor
    ...
    public func configure(with notification: ZipNotification){
        ...
        cellText.text = "Zipper Luanch Party starts in 24 hours!"
