...
//        mapVC.isNewAccount = true
        ...
        viewControllers = [eventsNav, searchNav, mapNav, messagesNav, notificationsNav]
...
extension ZipperTabBarViewController: CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        ZipperTabBarViewController.userLoc = latestLocation.coordinate
        
        if locations.count == 1 {
            locationDelegate?.zoomMap()
        }
        locationDelegate?.locationUpdated()
    }
