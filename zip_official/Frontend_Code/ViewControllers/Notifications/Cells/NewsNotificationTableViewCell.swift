//
//  NewsNotificationTableViewCell.swift
//  zip_official
//
...
class NewsNotificationTableViewCell: UITableViewCell {
    static let identifier = "NewsUpdate"
    ...
    let openButton: UIButton = {
        let btn = UIButton()
        btn.layer.backgroundColor = UIColor.zipBlue.cgColor
    ...
    public func configure(with notification: Notification){
        ...
        cellText.text = "What's new in Zipper 1.4! Find out Here!"
