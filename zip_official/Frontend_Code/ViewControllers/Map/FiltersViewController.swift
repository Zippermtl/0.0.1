...
class FiltersViewController: UIViewController {
    ...
    @objc func didTapMen(){
        ...
        AppDelegate.userDefaults.setValue(0, forKey: "GenderFilter")
    }
    ...
    @objc func didTapWomen(){
        ...
        everyoneButton.backgroundColor = .zipLightGray
        AppDelegate.userDefaults.setValue(1, forKey: "GenderFilter")
    }
    ...
    @objc func didTapEveryone(){
        ...
        AppDelegate.userDefaults.setValue(2, forKey: "GenderFilter")
    }
...
//        outlineView.addSubview(blueSlider)
//        outlineView.addSubview(greenSlider)
    ...
    private func configureSubviewConstraints(){
        ...
        outlineView.bottomAnchor.constraint(equalTo: pinkSlider.bottomAnchor, constant: 5).isActive = true
        ...
        blueRingLabel.topAnchor.constraint(equalTo: everyoneButton.bottomAnchor, constant: 5).isActive = true
